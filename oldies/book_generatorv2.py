...
book_title = "Forgotten Kingdom"  # Title of the book
num_chapters = 2  # Number of chapters in the book
num_subchapters = 2  # Number of subchapters per chapter
...
reviewModelTemperature = 0.4  # Temperature for the AI review process
reviewModelMaxOutputTokens = 4096  # Maximum tokens for the AI review
# --- Restricted words ---
restricted_words = [
    "shatter", "shattered", "shattered", "echo", "echoes", "echoes", "meticulous",
    "meticulously", "navigating", "complexities", "realm", "understanding", "dive in",
    "shall", "tailored", "towards", "underpins", "everchanging", "ever-evolving",
    "the world of", "not only", "alright", "embark", "Journey", "In today's digital age",
    "hey", "game changer", "designed to enhance", "it is advisable", "daunting",
    "in the realm of", "amongst", "unlock the secrets", "unveil the secrets", "and robust",
    "diving", "elevate", "unleash", "power", "cutting-edge", "rapidly", "expanding",
    "mastering", "excels", "harness", "imagine", "It's important to note", "Delve into",
    "Tapestry", "Bustling", "In summary", "Remember that", "Take a dive into", "Navigating",
    "Landscape", "Testament", "In the world of", "Realm", "Embark",
    "Analogies to being a conductor or to music", "Vibrant", "Metropolis", "Firstly",
    "Moreover", "Crucial", "To consider", "There are a few considerations", "Ensure",
    "Furthermore", "Fancy", "As a professional", "Therefore", "Additionally", "Specifically",
    "Generally", "Consequently", "Importantly", "nitty-gritty", "Thus", "Alternatively",
    "Notably", "As well as", "Weave", "Despite", "Essentially", "While", "Also",
    "Even though", "Because", "In contrast", "Although", "In order to", "Due to",
    "Even if", "Arguably", "On the other hand", "It's worth noting that", "To summarize",
    "Ultimately", "To put it simply", "Promptly", "Dive into", "In today's digital era",
    "Reverberate", "Enhance", "Emphasize", "Revolutionize", "Foster", "Remnant",
    "Subsequently", "Nestled", "Game changer", "Labyrinth", "Enigma", "Whispering",
    "Sights unseen", "Sounds unheard", "Indelible", "My friend", "Buzz", "In conclusion",
    "gaze", "voice", "grim", "dark", "shadow/shadows", "light", "eyes", "seemed", "like",
    "felt", "though", "around", "suddenly", "still", "just", "even", "now", "back",
    "almost", "upon", "within", "beneath", "against", "amidst", "grimace", "However",
    "Indeed", "Nevertheless", "Particularly", "Significantly", "Remarkably", "Potentially",
    "Accordingly", "Conversely", "besides", "as a result", "because of this",
    "for this reason", "regardless", "notwithstanding", "whereas", "similarly", "likewise",
    "comparatively", "meanwhile", "afterward", "previously", "basically", "fundamentally",
    "primarily", "crucially", "especially", "absolutely", "definitely", "clearly",
    "obviously", "if", "unless", "provided that", "although", "despite", "secondly",
    "thirdly", "finally", "initially", "certainly", "undoubtedly", "presumably",
    "possibly", "likely", "typically", "usually", "namely", "abruptly", "instantaneously",
    "unexpectedly", "in addition to", "as well as", "coupled with", "not only that",
    "on top of that", "on the contrary", "instead", "while", "despite this", "in spite of",
    "yet", "still", "hence", "thus", "in the event that", "as long as",
    "on the condition that", "in particular", "above all", "next", "at the same time",
    "for example", "for instance", "such as", "that is", "in other words", "to illustrate",
    "to demonstrate", "to sum up", "in short", "overall", "in essence", "absolutely",
    "certainly", "clearly", "obviously", "undoubtedly", "particularly", "significantly",
    "vitally", "above all", "mainly", "precisely", "exactly", "literally", "strictly",
    "unequivocally", "explicitly", "comprehensively", "accurately", "solely", "highly",
    "greatly", "deeply", "thoroughly", "fully", "completely", "extremely", "intensely",
    "exceptionally", "utterly", "considerably", "more importantly", "most significantly",
    "it is crucial that", "it is essential that", "of utmost importance", "to a great extent",
    "to a large degree"
]
...
review_model = genai.GenerativeModel("gemini-2.0-flash-thinking-exp-1219")  # You can use a different model for review if desired
...
# --- Keyword Extraction ---
extracted_keywords = extract_keywords(book_title)
keywords_string = ", ".join(extracted_keywords)

# --- First Call: Generate Chapter Titles ---
prompt_chapters = f"""
GENERATE a JSON dictionary representing the outline for a dark fantasy book titled '{book_title}'.
...
GENERATE unique and evocative chapter titles suitable for dark fantasy, incorporating the following themes: {keywords_string}.
FOR each chapter, GENERATE unique and evocative subchapter titles, maintaining the dark fantasy tone and incorporating the following themes: {keywords_string}.
...
for character_name in character_names:
    ...
    The character description MUST BE suitable for a dark fantasy novel and incorporate the themes: {keywords_string}.
            ...
            for j, subchapter in enumerate(chapter["subchapters"]):
                ...
                while True:
                    try:
                        ...
                        result_revision = review_model.generate_content(
                            prompt_revision,
                            generation_config=genai.GenerationConfig(
                                temperature=reviewModelTemperature,
                                top_p=modelTopP,
